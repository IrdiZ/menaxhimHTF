            ...
            <FormColumn>
                <FormRow style={{ padding: "0", paddingRight: "3em", paddingLeft: "3em", margin: "0", }}>
                    ...
                    <FormColumn style={{ padding: "0.4em", margin: "0", color: theme.colors.viewText }}>
                        <Heading2 >Irdi Noel</Heading2>

                        <FormRow style={{ padding: "0" }}><Paragraph >Admission No:</Paragraph>
                            <Paragraph style={{ color: theme.colors.viewText, paddingLeft: "0.6em" }}>2022_227</Paragraph>
                            <Paragraph style={{ paddingLeft: "2em" }}>Klasa:</Paragraph>
                            <Paragraph style={{ paddingLeft: "0.6em", color: theme.colors.viewText }}>3 - </Paragraph>
                            <Paragraph style={{ color: theme.colors.viewText, paddingLeft: "0.1em" }}>8</Paragraph></FormRow>
                ...
                <FormRow>
                    ...
                    <Card style={{ padding: "0.9em", width: "65em", color: theme.colors.viewText }}>
                        ...
                        <FormRow style={{ padding: "0" }}>
                            ...
                            <FormColumn viewprofile><Paragraph >Tirane</Paragraph></FormColumn>

                            <FormColumn viewprofile><Paragraph style={{ color: theme.colors.viewhed }}>StudyStart:</Paragraph></FormColumn>
                            <FormColumn viewprofile><Paragraph>2019.09.09</Paragraph></FormColumn>

                            <FormColumn viewprofile><Paragraph style={{ color: theme.colors.viewhed }}>Graduation:</Paragraph></FormColumn>
                            <FormColumn viewprofile><Paragraph>2022:02:25</Paragraph></FormColumn>
                        </FormRow>
                    ...
                    <FormRow>
                        <Card style={{ padding: "0.9em", color: theme.colors.viewText }}>
                            ...
                            <FormRow style={{ padding: "0" }}>
                                ...
                                <FormColumn viewprofile><Paragraph>no</Paragraph></FormColumn>
                            </FormRow>
                        ...
                        <Card style={{ padding: "0.9em", color: theme.colors.viewText }}>
                            ...
                            <FormRow style={{ padding: "0" }}>
                                <FormColumn viewprofile><Paragraph style={{ color: theme.colors.viewhed }}>Name:</Paragraph></FormColumn>
                                <FormColumn viewprofile><Paragraph>Ilir</Paragraph></FormColumn>
                            </FormRow>

                            <FormRow style={{ padding: "0" }}>
                                <FormColumn viewprofile><Paragraph style={{ color: theme.colors.viewhed }}>SiblingsGrade:</Paragraph></FormColumn>
                                <FormColumn viewprofile><Paragraph>10A</Paragraph></FormColumn>
                            </FormRow>

                            <FormRow style={{ padding: "0" }}>
                                <FormColumn viewprofile><Paragraph style={{ color: theme.colors.viewhed }}>Siblings Admission:</Paragraph></FormColumn>
